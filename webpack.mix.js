...
mix.copyDirectory("resources/assets/media", "public/assets/media");
...
mixAssetsDir("assets/css/*.css", (src, dest) => mix.copy(src, dest));
mixAssetsDir("assets/css/**/*.css", (src, dest) => mix.copy(src, dest));
mixAssetsDir("assets/js/*.js", (src, dest) => mix.copy(src, dest));
