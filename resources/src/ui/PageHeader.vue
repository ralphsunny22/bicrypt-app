            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">{{ $t("Wallet Connect") }}</h5>
                        <button
                            type="button"
                            class="btn-close"
