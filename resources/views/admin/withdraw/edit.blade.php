                        ...
                        <div class="payment-method-item">
                            <div class="payment-method-header row">
                                ...
                                <div class="col-lg-9">
                                    <div class="row mt-1">
                                        <div class="col-md-6">
                                            <label class="h6">{{ __('Method Name') }} <span
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                        <div class="card border-primary">
                                            <h5 class="card-header bg-light">{{ __('Range') }}</h5>
                                            <div class="card-body">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
                                        <div class="card border-primary">
                                            <h5 class="card-header bg-light">{{ __('Charge') }}</h5>
                                            <div class="card-body">
                                                <label class="mt-1 h6">{{ __('Fixed Charge') }} <span
                                                        class="text-danger">*</span></label>
                                                <div class="input-group">
                                                    <div class="input-group-text">{{ __($general->cur_text) }}</div>
                                                    <input type="text" class="form-control" placeholder="0"
                                                ...
                                                <label class="mt-1 h6">{{ __('Percent Charge') }} <span
                                                        class="text-danger">*</span></label>
                                                <div class="input-group">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card border-dark my-2">
                                            ...
                                            <div class="card-body">
                                                <div class="col mt-1">
                                                    <textarea rows="5" class="form-control rounded" name="instruction">{{ $method->description }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card border-dark">
                                            ...
                                            <h5 class="card-header bg-dark text-white">{{ __('User data') }}
                                                <button type="button"
                                                    class="btn btn-sm btn-outline-light float-end addUserData">
                                                    <i class="bi bi-plus"></i>{{ __('Add new') }}
                                                </button>
                                            </h5>
                                                                    ...
                                                                    <div class="input-group mb-md-0 mb-4">
                                                                        ...
                                                                        <div class="col-md-2 mt-md-0 mt-2 text-end">
                                                                            <span class="input-group-btn">
                                                                                <button
                                                                                    class="btn btn-danger btn-lg removeBtn h6"
                                                                                    type="button">
                                                                                    <i class="bi bi-x"></i>
                                                                                </button>
                                                                            </span>
    ...
    <script>
        $(function() {
            ...
            $('.addUserData').on('click', function() {
                ...
                <div class="col-md-12 user-data">
                    <div class="col">
                        <div class="row mt-1 input-group mb-md-0 mb-4">
                            <div class="col-md-4">
