        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="card">
                    ...
                    <hr>
                    <div class="card-body">
                        <h4 class="mb-2">{{ __('Settings of') }} {{ __($gateway->name) }}</h4>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div>
                                                    <div class="input-group-text">
                                                        <span class="copyInput" data-bs-toggle="tooltip"
                                                            data-bs-placement="top" title="{{ __('Copy') }}"><i
            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                            ...
                            @foreach ($gateway->currencies as $gateway_currency)
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                        ...
                                        <input type="text" class="form-control" placeholder="{{ __('Name for Provider') }}"
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                            <div class="card mt-2">
                                <h5 class="card-header bg-primary text-white">{{ __('Payment Limits') }}</h5>
                                <div class="card-body">
                                    <label class="w-100 mt-1">{{ __('Minimum Amount') }} <span
                                            class="text-danger">*</span></label>
                                    <div class="input-group mb-1">
                                        <div class="input-group-text">{{ __(getcurrency()->code) }}</div>
                                        <input type="text" class="form-control"
                                            name="currency[{{ $currency_idx }}][min_amount]"
                                            value="{{ ttz($gateway_currency->min_amount) }}" placeholder="0" required />
                                    </div>
                                    <label class="w-100">{{ __('Maximum Amount') }} <span
                                            class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <div class="input-group-text">{{ __(getcurrency()->code) }}</div>
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                            <div class="card mt-2">
                                <h5 class="card-header bg-primary text-white">{{ __('Fees') }}</h5>
                                <div class="card-body">
                                    <label class="w-100 mt-1">{{ __('Fixed Fee') }} <span
                                            class="text-danger">*</span></label>
                                    <div class="input-group mb-1">
                                        <div class="input-group-text">{{ __(getcurrency()->code) }}</div>
                                        <input type="text" class="form-control" placeholder="0"
                                    ...
                                    <label class="w-100">{{ __('Percentage Fee') }} <span
                                            class="text-danger">*</span></label>
                                    <div class="input-group">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                            <div class="card mt-2">
                                <h5 class="card-header bg-primary text-white">{{ __('Conversion Rate') }}</h5>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="my-1">
                                                <label class="w-100">{{ __('Currency') }}</label>
                                        ...
                                        <div class="col-md-6">
                                            <div class="my-1">
                                                <label class="w-100">{{ __('Symbol') }}</label>
                                    ...
                                    <label class="w-100">{{ __('Rate') }} <span class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <div class="input-group-text">1 {{ __(getcurrency()->code) }} = </div>
                                        <input type="text" class="form-control" placeholder="0"
                        ...
                        @if ($parameters->where('global', false)->count() != 0)
                            ...
                            <div class="col-lg-12">
                                <div class="card mt-2">
                                    <h5 class="card-header bg-dark text-white">{{ __('Configuration') }}</h5>
                                    <div class="card-body">
                                        <div class="row mt-1">
                ...
                <div class="child-item newMethodCurrency d-none">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <div class="col">
                                        <h4 class="mb-1" id="payment_currency_name">{{ __('Name') }}</h4>
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                            <div class="card mt-2">
                                <h5 class="card-header bg-primary text-white">{{ __('Range') }}</h5>
                                <div class="card-body">
                                    <label class="w-100 mt-1">{{ __('Minimum Amount') }} <span
                                            class="text-danger">*</span></label>
                                    <div class="input-group mb-1">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                            <div class="card mt-2">
                                <h5 class="card-header bg-primary text-white">{{ __('Charge') }}</h5>
                                <div class="card-body">
                                    <label class="w-100 mt-1">{{ __('Fixed Charge') }} <span
                                            class="text-danger">*</span></label>
                                    <div class="input-group mb-1">
                                        <div class="input-group-text">{{ __(getcurrency()->code) }}</div>
                                        <input disabled type="text" class="form-control" placeholder="0"
                                    ...
                                    <label class="w-100">{{ __('Percent Charge') }} <span
                                            class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <div class="input-group-text">%</div>
                                        <input disabled type="text" class="form-control" placeholder="0"
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-4">
                            <div class="card mt-2">
                                <h5 class="card-header bg-primary text-white">{{ __('Currency') }}</h5>
                                <div class="card-body">
                                    <div class="row mt-1">
                                        <div class="col-md-6">
                                            <label class="w-100">{{ __('Currency') }}</label>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ __('Provider Currency Remove Confirmation') }}</h5>
                ...
                <form action="{{ route('admin.payment.provider.remove', $gateway->code) }}" method="POST">
                    ...
                    <div class="modal-body">
                        <p>{{ __('Are you sure to delete') }} <span class="fw-bold name"></span>
...
@push('breadcrumb-plugins')
    <a href="{{ route('admin.payment.provider.index') }}" class="btn btn-primary"><i class="bi bi-chevron-left"></i>
        {{ __('Go Back') }}</a>
@endpush
