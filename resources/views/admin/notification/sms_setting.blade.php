            ...
            <div class="card">
                <form action="" method="POST">
                    ...
                    <div class="card-body">
                        <div class="row mb-1">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" class="form-check-input" data-height="40px" data-width="100%"
                                        data-onstyle="success" data-offstyle="danger" data-toggle="toggle"
                                        data-on="@lang('Send SMS')" data-off="@lang("Don't Send")" name="sms_status"
                                        @if (@$notification->sms_status) checked @endif>
                                </div>
                            </div>
                        </div>
                        <hr>
                        <div class="row mt-2 d-none configForm" id="clickatell">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="@lang('API Key')"
                                        ...
                                        value="{{ @$notification->sms_config->clickatell->api_key }}" />
                                </div>
                            </div>
                        </div>
                        <div class="row mt-2 d-none configForm" id="infobip">
                            <div class="col-md-12">
                        ...
                        <div class="row mt-2 d-none configForm" id="messageBird">
                            <div class="col-md-12">
                        ...
                        <div class="row mt-2 d-none configForm" id="nexmo">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>@lang('API Key') </label>
                                    <input type="text" class="form-control" placeholder="@lang('API Key')"
                                        name="nexmo_api_key" value="{{ @$notification->sms_config->nexmo->api_key }}" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="row mt-2 d-none configForm" id="smsBroadcast">
                            <div class="col-md-12">
                        ...
                        <div class="row mt-2 d-none configForm" id="twilio">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="@lang('Auth Token')"
                                        name="auth_token" value="{{ @$notification->sms_config->twilio->auth_token }}" />
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="@lang('From Number')"
                                        name="from" value="{{ @$notification->sms_config->twilio->from }}" />
                                </div>
                            </div>
                        </div>
                        <div class="row mt-2 d-none configForm" id="textMagic">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="@lang('Username')"
                                        ...
                                        value="{{ @$notification->sms_config->text_magic->username }}" />
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="row mt-2 d-none configForm" id="custom">
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="custom_api_url"
                                            value="{{ @$notification->sms_config->custom->url }}"
    ...
    <div id="testSMSModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.settings.mail.sms.test') }}" method="POST">
                    @csrf
...
@push('breadcrumb-plugins')
    <button type="button" data-bs-target="#testSMSModal" data-bs-toggle="modal" class="btn btn-outline-primary btn-sm">
        <i class="bi bi-paper-plane"></i> @lang('Send Test SMS')</button>
@endpush
@push('style')
    <style>
        .method-select {
