...
@section('content')
    <div class="col-4 card text-center mx-auto">
        <div class="card-body">
            <h1 class="card-title">{{ __('License Deactivator') }}</h1><br>
            <div class="box">
                ...
                @if (!empty($_POST))
                    ...
                    @if ($deactivate_response['status'] != true)
                        <form action="{{ route('admin.lic.deactivate') }}" method="POST">
                            ...
                            <center>
                                <button type="submit" class="btn btn-danger">{{ __('Deactivate License') }}</button>
                            </center>
                        </form>
                    @else
                        <div class="alert alert-success mb-1">
    ...
    <div class="col-6 text-center mx-auto">
        <p>{{ __('Copyright') }} {{ date('Y') }} {{ __('Mashdiv, All rights reserved.') }}</p><br>
    </div>
@endsection
