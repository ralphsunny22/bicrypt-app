            ...
            <div class="card content-area">
                <div class="card-innr">
                    <div class="card-head d-flex justify-content-between align-items-center">
                        <h4 class="card-title mb-1">{{ __('KYC Information of') }}
                            <span>{{ _x($kyc->firstName) . ' ' . _x($kyc->lastName) }}
                        </h4>
                        <div class="d-flex align-items-center guttar-20px">
                            <div class="flex-col d-sm-block d-none">
                                <a href="{{ route('admin.kycs') }}" class="btn btn-light btn-sm btn-auto btn-primary"><i
                                        class="bi bi-chevron-left mr-3"></i> {{ __('Back') }}</a>
                            </div>
                            <div class="flex-col d-sm-none">
                                <a href="{{ route('admin.kycs') }}" class="btn btn-icon btn-sm btn-primary"><i
                                        class="bi bi-arrow-left"></i></a>
                            </div>
                            <div class="relative d-inline-block">
                                <div class="dropdown">
                                    <button type="button" class="btn btn-dark btn-icon btn-sm ms-1" id="dropdownMenuButton"
                                        ...
                                        @if ($kyc->status != 'approved')
                                            <a class="dropdown-item kyc_action kyc_approve" data-bs-toggle="modal"
                                                ...
                                                data-toggle="modal" data-target="#actionkyc"><i
                                                    class="bi bi-check-square"></i> {{ __('Update Status') }}</a></li>
                                        @endif
                            ...
                            @if ($kyc->document != null || $kyc->document2 != null || $kyc->document3 != null)
                                <ul class="data-details-docs">
                                    @if ($kyc->document != null)
                                        <li>
                                            <span
                                                class="data-details-docs-title">{{ $kyc->documentType == 'nidcard' ? 'Front Side' : 'Document' }}</span>
                                            <div class="data-doc-item data-doc-item-lg">
                                                ...
                                                <ul class="data-doc-actions">
                                                    <li><a href="{{ getImage('assets/images/kyc/' . $kyc->document) }}"
                                                            target="_blank"><i
                                                                class="bi bi-cloud-download text-white"></i></a></li>
                                                </ul>
                                            </div>
                                        </li>{{-- li --}}
                                    @endif
                                    @if ($kyc->document2 != null)
                                        <li>
                                            <span
                                                class="data-details-docs-title">{{ $kyc->documentType == 'nidcard' ? 'Back Side' : 'Proof' }}</span>
                                            <div class="data-doc-item data-doc-item-lg">
                                                <div class="data-doc-image">
                                                    <img class="img-fluid img-thumbnail"
