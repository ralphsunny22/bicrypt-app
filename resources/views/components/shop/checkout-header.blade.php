@props([
    'links' => [['title' => 'Customer', 'icon' => 'user', 'url' => 'customer'], ['title' => 'Shipping', 'icon' => 'address-card', 'url' => 'shipping'], ['title' => 'Payment', 'icon' => 'credit-card', 'url' => 'payment'], ['title' => 'Confirmation', 'icon' => 'check-square', 'url' => 'confirmation']],
    'title' => '',
    'subtitle' => '',
])
        ...
        <div class="container bring-to-front py-0">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb small py-2">
                    ...
                    <li class="breadcrumb-item"><a href="shop-index">{{ __('Shop') }}</a></li>
