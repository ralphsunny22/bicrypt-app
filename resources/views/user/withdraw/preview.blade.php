...
@section('content')
    <div class="card col-lg-6 col-md-6">
        <div class="card-header">
            <h5 class="m-0"><span class="text-base">{{ __('Withdrawal Confirmation') }}</span></h5>
        </div>
        <div class="card-content mx-2">
            ...
            <div class="input-group">
                <input type="text" value="{{ getAmount($wallet->balance - $withdraw->amount * $withdraw->rate) }}"
                    class="form-control" placeholder="Enter Amount" required="" readonly="">
                            ...
                            <div class="col">
                                <div class="fileinput fileinput-new " data-provides="fileinput">
                                    <div class="fileinput-new thumbnail withdraw-thumbnail" data-trigger="fileinput">
                                        <img class="w-100" src="{{ getImage('/') }}" alt="{{ __('image') }}">
                                    </div>
