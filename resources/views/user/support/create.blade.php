        ...
        <div class="col-md-6 col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">{{ __('Create New Ticket') }}</h4>
                    <a href="{{ route('ticket') }}" class="btn btn-primary btn-sm">{{ __('All Tickets') }}</a>
                </div>
                <div class="card-body">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="add-area">
                                    ...
                                    <button class="btn btn-primary btn-sm bg-primary ms-2 ms-md-4"
                                        onclick="extraTicketAttachment()" type="button"><i class="bi bi-plus"></i></button>
                                </div>
                            </div>
                        </div>
