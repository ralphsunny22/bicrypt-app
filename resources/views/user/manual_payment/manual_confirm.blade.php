                    ...
                    <form action="{{ route('user.deposit.manual.update') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <p class="text-center mt-2">{{ __('You have requested') }} <b
                                ...
                                <h4 class="text-center mb-4">{{ __('Please follow the instruction bellow') }}</h4>
                            ...
                            <div class="col-md-12">
                                <div class="col">
                                    <button type="submit" class="btn btn-success mt-2 w-100">{{ __('Pay Now') }}</button>
                                </div>
                            </div>
