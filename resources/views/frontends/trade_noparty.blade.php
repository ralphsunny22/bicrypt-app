                ...
                <div class="row match-height">
                    ...
                    <div class="col mt-1 me-1">
                        <div class="">
                            ...
                            <input class="form-control text-light" type="text" value="0" disabled>
                        </div>
                        <div class="mt-1">
                ...
                <div class="card">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="market" aria-labelledby="market-tab" role="tabpanel">
                            <form class="text-center mt-1" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" id="symbol" name="symbol" value="{{ $symbol }}">
                                <input type="hidden" id="currency" name="currency" value="{{ $currency }}">
                                ...
                                <div class="input-group mb-1 mx-1 w-auto">
                                    <input type="number" class="form-control" step=".0000001" required=""
                                        id="amount" disabled name="amount" placeholder="Amount">
                                    <span class="input-group-text text-light" id="amount">{{ $symbol }}</span>
                                </div>
                                <div class="input-group mb-1 mx-1 w-auto">
                                    <span class="input-group-text text-light">Fees</span>
                                    <input type="number" class="form-control" disabled
                                        value="{{ getGen()->exchange_fee }}">
                        ...
                        <div class="tab-pane" id="limit" aria-labelledby="limit-tab" role="tabpanel">
                            <form method="POST" action="{{ route('user.trade.store') }}" class="text-center mt-1"
                                ...
                                <div class="input-group mb-1 mx-1 w-auto">
                                    <input type="number" class="form-control" step=".0000001" required=""
                                        id="price" disabled name="price" placeholder="Price"
                                        value="{{ ttz(getRate($symbol . $currency)) }}">
                                ...
                                <div class="mx-1">
                                    <button
                                        class="col d-flex justify-content-between align-items-center w-100 btn btn-success"
                                        type="submit" id="type" name="type" value="1" disabled>
                                        <div class="text-start">Buy</div>
                                        <div class="text-end"> {{ $symbol }}</div>
                                    </button>
                                    <button
                                        class="col d-flex justify-content-between align-items-center w-100  my-1 btn btn-danger"
                                        type="submit" id="type" name="type" value="2" disabled>
                                        <div class="text-start">Sell</div>
                                        <div class="text-end"> {{ $symbol }}</div>
                                    </button>
                                </div>
            ...
            document.getElementById('toggleDepth').onclick = function() {
                ...
                if (timesClicked % 2 == 0) {
                    ws_i.send(JSON.stringify({
                        'method': 'UNSUBSCRIBE',
                        'params': [
                            '{{ strtolower($symbol) }}{{ strtolower($currency) }}@depth20@100ms'
                        ],
                        'id': 2
                    }))
                } else {
            ...
            document.getElementById('toggleOrders').onclick = function() {
                ...
                if (timesClicked % 2 == 0) {
                    ws_i.send(JSON.stringify({
                        'method': 'UNSUBSCRIBE',
                        'params': [
                            '{{ strtolower($symbol) }}{{ strtolower($currency) }}@depth10@100ms'
                        ],
                        'id': 1
                    }))
                } else {
