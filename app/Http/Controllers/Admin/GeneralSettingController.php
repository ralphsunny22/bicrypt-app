...
class GeneralSettingController extends Controller
{
    public function index()
    {
        ...
        return view('admin.setting.general_setting', compact('page_title', 'general', 'limits', 'bot', 'wal_connect', 'notify_settings'));
    }
    ...
    public function update(Request $request)
    {
        ...
        if (getExt(10)->status == 1) {
            ...
            $native_settings = \App\Models\Eco\EcoSettings::first();
            $native_settings->network = $request->input('NETWORK', null);
