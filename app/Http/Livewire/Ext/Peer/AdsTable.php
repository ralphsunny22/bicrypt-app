    ...
    public function columns(): array
    {
        return [
            ...
            Column::make("User", "user_id")
                ...
                ->sortable()
                ->format(
                    fn ($value, $row, Column $column) => '<a href="' . route('admin.users.detail', $row->user_id) . '" class="badge bg-light-primary">' . ucfirst($row->user->username) . '</a>'
                )
                ->html(),
            Column::make("Currency", "currency_id")
                ...
                ->sortable()
                ->format(
                    fn ($value, $row, Column $column) => '<span class="badge bg-light-info">' . $row->currency->symbol . '</span>'
                )
                ->html(),
            ...
            Column::make("Fiat Currency", "fiat_currency")
                ...
                ->sortable()
                ->format(
                    fn ($value, $row, Column $column) => '<span class="badge bg-light-secondary">' . $row->fiat_currency . '</span>'
                )
                ->html(),
            ...
            Column::make("Type", "type")
                ...
                ->sortable()
                ->format(
                    fn ($value, $row, Column $column) => '<span class="badge bg-light-warning">' . ucfirst($row->type) . '</span>'
                )
                ->html(),
