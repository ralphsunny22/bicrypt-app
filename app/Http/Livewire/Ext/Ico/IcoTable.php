    ...
    public function columns(): array
    {
        return [
            ...
            Column::make("Name", "name")
                ...
                ->sortable()
                ->format(
                    fn ($value, $row, Column $column) => '<span class="badge bg-light-primary">' . $row->name . '</span>'
                )
                ->html(),
            ...
            Column::make("Type", "type")
                ...
                ->sortable()
                ->format(
                    fn ($value, $row, Column $column) => '<span class="badge bg-light-info">' . ($row->type == 1 ? 'Soft' : 'Soft/Hard') . '</span>'
                )
                ->html(),
