    ...
    public function columns(): array
    {
        return [
            ...
            Column::make("Type", "type")
                ...
                ->collapseOnMobile()
                ->format(
                    fn ($value, $row, Column $column) => '<span class="badge bg-light-' . ($row->type == 1 ? 'success' : 'danger') . '">' . ($row->type == 1 ? 'Deposit' : 'Withdraw') . '</span>'
                )
                ->html(),
            ...
            Column::make("Status", "status")
                ...
                ->collapseOnMobile()
                ->format(
                    fn ($value, $row, Column $column) => '<span class="badge bg-light-' . ($row->status == 1 ? 'success' : 'warning') . '">' . ($row->status == 1 ? 'Completed' : 'Pending') . '</span>'
                )
                ->html(),
