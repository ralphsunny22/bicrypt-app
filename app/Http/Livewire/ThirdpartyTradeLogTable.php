...
use App\Exports\ThirdpartyOrdersLogExport;
...
class ThirdpartyTradeLogTable extends DataTableComponent
{

    protected $model = ThirdpartyOrders::class;
    ...
    public function export()
    {
        ...
        $this->clearSelected();
        return Excel::download(new ThirdpartyOrdersLogExport($logs), 'thirdparty_orders_log.xlsx');
    }
}